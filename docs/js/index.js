    ...
    for (var j = 0; j < 7; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr += '<td style="text-align: center">' +
                ...
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_fake3.ogg"  type="audio/ogg"></audio>' +
                '</td>';
            tr += '</tr>';
            ...
            tr2 = '<tr><td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_real.ogg" type="audio/ogg"></audio>' +
                '</td></tr>';
            tr3 = '<tr><th>Fakes</th></tr>';
            tr4 = '<tr><td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_fake1.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/instruments/' + instruments_files[idx] + '_fake3.ogg" type="audio/ogg"></audio>';
            tr4 += '</td></tr>';
...
function load_speeches_files() {
    ...
    for (var j = 0; j < 5; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_real.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_fake1.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
            ...
            tr2 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_real.ogg" type="audio/ogg"></audio></td></tr>';
            tr3 = '<tr><th>Fakes</th></tr>';
            tr4 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_fake1.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/speeches/' + speeches_files[idx] + '_fake3.ogg" type="audio/ogg"></audio></td></tr>'
...
function load_ambient_files() {
    ...
    for (var j = 0; j < 5; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_real.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake1.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake3.ogg" type="audio/ogg"></audio>' +
                '</td>';
            ...
            tr2 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_real.ogg" type="audio/ogg"></audio></td></tr>';
            tr3 = '<tr><th>Fakes</th></tr>';
            tr4 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake1.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake2.ogg" type="audio/ogg"></audio>';
            tr4 += '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/unconditional/ambient/' + ambient_files[idx] + '_fake3.ogg" type="audio/ogg"></audio></td></tr>';
...
function create_rf_table() {
    ...
    for (var i = 0; i < 2; i++) {
        if (!is_small_screen) {
            ...
            tr += '<td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_real.ogg" type="audio/ogg"></audio></td>';
            tr += '<td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_small1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_small2_fake.ogg" type="audio/ogg"></audio></td>';
            tr += '<td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_normal1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_normal2_fake.ogg" type="audio/ogg"></audio></td>';
            tr += '<td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_large1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_large2_fake.ogg" type="audio/ogg"></audio></td>';
            tr += '</tr>';
            $("#rf_table").append(tr);
        } else {
            tr = '<tr><th style="text-align: center; width: 100px">' + lengths[i] + ' [sec] training length<hr>Input (Real)</th></tr>';
            tr2 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_real.ogg" type="audio/ogg"></audio></td></tr>';
            tr3 = '<tr><th>Small Receptive Field<br>2[sec]-60[ms]</th></tr>';
            tr4 = '<tr><td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_small1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_small2_fake.ogg" type="audio/ogg"></audio></td></tr>';
            tr5 = '<tr><th>Normal Receptive Field<br>4[sec]-120[ms]</th></tr>';
            tr6 = '<tr><td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_normal1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_normal2_fake.ogg" type="audio/ogg"></audio></td></tr>';
            tr7 = '<tr><th>Small Receptive Field<br>2[sec]-60[ms]</th></tr>';
            tr8 = '<tr><td style="text-align: center"><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_large1_fake.ogg" type="audio/ogg"></audio><br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/rf/' + i + '_trump_large2_fake.ogg" type="audio/ogg"></audio></td></tr>';
...
function load_music_files() {
    ...
    for (var j = 0; j < 5; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_real.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_fake1.wav" type="audio/wav"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_fake2.wav" type="audio/wav"></audio>' +
                '</td>';
            tr += '</tr>';
            ...
            tr2 = '<tr><td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_real.ogg" type="audio/ogg"></audio</td></tr>';
            tr3 = '<tr><th>Fakes</th></tr>';
            tr4 = '<tr><th><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_fake1.wav" type="audio/wav"></audio><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/music/' + music_files[idx] + '_fake2.wav" type="audio/wav"></audio></th></tr>';
...
function load_sr_files() {
    ...
    for (var j = 0; j < 3; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_lr.ogg" type="audio/ogg"></audio></td>';
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_gt.ogg" type="audio/ogg"></audio></td>';
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_training.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_pr_single.ogg" type="audio/ogg"></audio></td>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_pr_multi.ogg" type="audio/ogg"></audio></td>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_ours.ogg" type="audio/ogg"></audio></td></tr>';
            $('#sr_table').append(tr);
            $('#sr_table').append(tr2);
            $('#sr_table').append(tr3);
        } else {
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_lr.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_gt.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr2 += '<audio controls><aource src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_training.ogg" type="audio/ogg"</audio></td></tr>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr/' + sr_files[idx] + '_pr_multi.ogg" type="audio/ogg"></audio></td></tr>';
...
function load_sr_files_8() {
    ...
    for (var j = 0; j < 3; j++) {
        ...
        if (!is_small_screen) {
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_lr.ogg" type="audio/ogg"></audio></td>';
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_gt.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_training.ogg" type="audio/ogg"></audio></td>';
            ...
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_ours.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr = '<tr><th colSpan="4" style="background-color: lightgrey; background-clip: padding-box">' + sr_files_8[idx] + '</th></tr>';
            tr2 = '<tr><td style="text-align: center">Input (Low Resolution)<div className="imgbox"><img className="center-fit" src="graphics/sr_8_to_16/' + sr_files_8[idx] + '_lr.png" width="300"></div>';
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_lr.ogg" type="audio/ogg"></audio></td></tr>';
            ...
            tr2 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_gt.ogg" type="audio/ogg"></audio></td></tr></tr>';
            tr3 = '<tr><td style="text-align: center">Our Training Signal<div className="imgbox"><img className="center-fit" src="graphics/sr_8_to_16/' + sr_files_8[idx] + '_training.png" width="300"></div>';
            tr3 += '<audio controls><source src="' + audio_base_url + 'audio/sr_8_to_16/' + sr_files_8[idx] + '_training.ogg" type="audio/ogg"></audio></td></tr>';
...
function load_inpainting_files() {
    ...
    for (var j = 0; j < 5; j++) {
        ...
        if (!is_small_screen) {
            tr = '<tr>';
            tr += '<td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-with_hole.ogg" type="audio/ogg"></audio></td>';
            tr += '<td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-real.ogg" type="audio/ogg"></audio></td>';
            tr += '<td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-gacela.ogg" type="audio/ogg"></audio></td>';
            tr += '<td><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-ours.ogg" type="audio/ogg"></audio></td>';
            tr += '</tr>';
            ...
            tr = '<tr><td>';
            tr += '<table><tr><th style="background-color: ' + bg_color + '">Input<br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-with_hole.ogg" type="audio/ogg"></audio></th></tr>';
            tr += '<tr><th style="background-color: ' + bg_color + '">GT<br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-real.ogg" type="audio/ogg"></audio></th></tr>';
            tr += '<tr><th style="background-color: ' + bg_color + '">GACELA<br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-gacela.ogg" type="audio/ogg"></audio></th></tr>';
            tr += '<tr><th style="background-color: ' + bg_color + '">Ours<br><audio class="short-audio" controls><source src="' + audio_base_url + 'audio/inpainting/' + inpainting_files[idx] + '-ours.ogg" type="audio/ogg"></audio></th></tr>';
            tr += '</table></td></tr>';
...
function load_denoising_files() {
    ...
    for (var j = 0; j < denoising_files.length; j++) {
        if (!is_small_screen) {
            ...
            txt += '<audio id="denoising_real' + String(j) + '" ><source src="' + audio_base_url + 'audio/denoising/' + denoising_files[j].replaceAll(' ', '_') + '_real.ogg" type="audio/ogg"></audio>';
            txt += '<audio muted id="denoising_rec' + String(j) + '" ><source src="' + audio_base_url + 'audio/denoising/' + denoising_files[j].replaceAll(' ', '_') + '_rec.ogg" type="audio/ogg"></audio>';
            txt += '</th>';
            txt += '</tr>';
            txt += '<tr>';
...
function load_denoising_synth_files() {
    ...
    for (var j = 0; j < denoising_synth_files.length; j++) {
        if (!is_small_screen) {
            ...
            txt += '<audio id="denoising_synth_noisy' + String(j) + '"><source src="' + audio_base_url + 'audio/denoising_synth/' + denoising_synth_files[j].replaceAll(' ', '_') + '_noisy.ogg" type="audio/ogg"></audio>';
            txt += '<audio muted id="denoising_synth_rec' + String(j) + '" ><source src="' + audio_base_url + 'audio/denoising_synth/' + denoising_synth_files[j].replaceAll(' ', '_') + '_rec.ogg" type="audio/ogg"></audio>';
            txt += '</th>';
            txt += '</tr>';
            txt += '<tr>';
            ...
            txt += '<audio id="denoising_synth_real' + String(j) + '"><source src="' + audio_base_url + 'audio/denoising_synth/' + denoising_synth_files[j].replaceAll(' ', '_') + '_noisy.ogg" type="audio/ogg"></audio>';
            txt += '<audio muted id="denoising_synth_rec' + String(j) + '"><source src="' + audio_base_url + 'audio/denoising_synth/' + denoising_synth_files[j].replaceAll(' ', '_') + '_rec.ogg" type="audio/ogg"></audio>';
            txt += '</th></tr>';
...
function load_limitations_files() {
    ...
    for (var j = 0; j < 5; j++) {
        ...
        if (!is_small_screen) {
            tr = '<tr>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/limitations/' + limitations_files[idx] + '_real.ogg" type="audio/ogg"></audio>' +
                '</td>';
            tr += '<td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/limitations/' + limitations_files[idx] + '_fake.ogg" type="audio/ogg"></audio>' +
                '</td>';
            ...
            tr += '<th>Fake</th>';
            tr += '<tr><td style="text-align: center">' +
                '<audio class="short-audio" controls><source src="' + audio_base_url + 'audio/limitations/' + limitations_files[idx] + '_fake.ogg" type="audio/ogg"></audio><br>' + explanations[idx] +
                '</td></tr>';
