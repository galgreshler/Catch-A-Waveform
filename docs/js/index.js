...
function load_music_files() {
    for (var j=0; j<5; j++) {
        ...
        tr+='<td align="center">' +
            '<audio src="audio/music/'+music_files[idx]+'_real.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/music/'+music_files[idx]+'_fake1.wav" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/music/'+music_files[idx]+'_fake2.wav" controls></audio>' +
            '</td>';
        tr += '</tr>';
...
function load_denoising_files() {
    ...
    for (var j=0; j<denoising_files.length; j++) {
        ...
        txt+='<audio src="audio/denoising/'+denoising_files[j].replaceAll(' ', '_')+'_real.ogg" id="denoising_real'+String(j)+'"></audio>';
        txt+='<audio muted src="audio/denoising/'+denoising_files[j].replaceAll(' ', '_')+'_rec.ogg" id="denoising_rec'+String(j)+'"></audio>';
        txt+='</th>';
        txt+='</tr>';
        txt+='<tr>';
...
function load_sr_files() {
    for (var j=0; j<3; j++) {
        ...
        // tr = '<tr>';
        // tr += '<th>'+sr_files[idx]+'</th>';
        // tr+='<td align="center" style="vertical-align: bottom; text-align: left">' +
        //     '<div class="imgbox">'+
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_lr.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_lr.ogg" controls></audio>' +
        //     '</td>';
        // tr+='<td align="center">' +
        //     '<div class="imgbox">' +
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_gt.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_gt.ogg" controls></audio>' +
        //     '</td>';
        // tr+='<td align="center">' +
        //     '<div class="imgbox">' +
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_pr_single.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_pr_single.ogg" controls></audio>' +
        //     '</td>';
        // tr+='<td align="center">' +
        //     '<div class="imgbox">' +
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_pr_multi.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_pr_multi.ogg" controls></audio>' +
        //     '</td>';
        // tr+='<td align="center">' +
        //     '<div class="imgbox">' +
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_training.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_training.ogg" controls></audio>' +
        //     '</td>';
        // tr+='<td align="center">' +
        //     '<div class="imgbox">' +
        //     '<img class="center-fit" src="graphics/sr/'+sr_files[idx]+'_ours.png">' +
        //     '</div>' +
        //     '<audio src="audio/sr/'+sr_files[idx]+'_ours.ogg" controls></audio>' +
        //     '</td>';
        // tr += '</tr>';
        // $('#sr_table').append(tr);
        ...
        tr2 += '<audio src="audio/sr/' + sr_files[idx] + '_lr.ogg" controls></audio></td>';
        ...
        tr2 += '<audio src="audio/sr/' + sr_files[idx] + '_gt.ogg" controls></audio></td>';
        ...
        tr2 += '<audio src="audio/sr/' + sr_files[idx] + '_training.ogg" controls></audio></td></tr>';
        ...
        tr3 += '<audio src="audio/sr/' + sr_files[idx] + '_pr_single.ogg" controls></audio></td>';
        ...
        tr3 += '<audio src="audio/sr/' + sr_files[idx] + '_pr_multi.ogg" controls></audio></td>';
        ...
        tr3 += '<audio src="audio/sr/' + sr_files[idx] + '_ours.ogg" controls></audio></td></tr>';
        $('#sr_table2').append(tr);
...
function load_instruments_files() {
    for (var j=0; j<7; j++) {
        ...
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/instruments/'+instruments_files[idx]+'_real.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/instruments/'+instruments_files[idx]+'_fake1.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/instruments/'+instruments_files[idx]+'_fake2.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/instruments/'+instruments_files[idx]+'_fake3.ogg" controls></audio>' +
            '</td>';
        tr += '</tr>';
...
function load_speeches_files() {
    for (var j=0; j<5; j++) {
        ...
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/speeches/'+speeches_files[idx]+'_real.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/speeches/'+speeches_files[idx]+'_fake1.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/speeches/'+speeches_files[idx]+'_fake2.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/speeches/'+speeches_files[idx]+'_fake3.ogg" controls></audio>' +
            '</td>';
...
function load_ambient_files() {
    for (var j=0; j<5; j++) {
        ...
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/ambient/'+ambient_files[idx]+'_real.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/ambient/'+ambient_files[idx]+'_fake1.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/ambient/'+ambient_files[idx]+'_fake2.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/unconditional/ambient/'+ambient_files[idx]+'_fake3.ogg" controls></audio>' +
            '</td>';
...
function load_limitations_files() {
    for (var j=0; j<5; j++) {
        ...
        tr = '<tr>';
        tr+='<th align="center">' + idx + '</th>';
        tr+='<td align="center">' +
            '<audio src="audio/limitations/'+limitations_files[idx]+'_real.ogg" controls></audio>' +
            '</td>';
        tr+='<td align="center">' +
            '<audio src="audio/limitations/'+limitations_files[idx]+'_fake.ogg" controls></audio>' +
            '</td>';
        tr += '</tr>';
